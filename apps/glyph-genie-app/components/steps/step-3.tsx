      ...
      <div className="animate-slide-left flex flex-col w-full container pt-12 pb-12">
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            <ArrowLeftIcon className="text-slate-900 cursor-pointer" size={24} onClick={() => setCurrentStep(currentStep - 2)}></ArrowLeftIcon>
          ...
          <h2 className="text-3xl font-bold tracking-tighter subpixel-antialiased border-b-2 border-slate-50 pb-4">Your Creations</h2>
        </div>
